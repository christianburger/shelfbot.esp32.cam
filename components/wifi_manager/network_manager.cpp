...
static void set_wifi_state(wifi_manager_state_t new_state) {
    ...
    WifiManagerState mapped;
    switch (new_state) {
        case WM_STATE_IDLE:       mapped = WifiManagerState::OFF; break;
        case WM_STATE_SCANNING:   mapped = WifiManagerState::CONNECTING; break;
        case WM_STATE_CONNECTING: mapped = WifiManagerState::CONNECTING; break;
        case WM_STATE_CONNECTED:  mapped = WifiManagerState::CONNECTED; break;
        case WM_STATE_DEGRADED:   mapped = WifiManagerState::CONNECTED; break;
        default:                  mapped = WifiManagerState::ERROR; break;
    }
    StateMachine::changeState("wifi", stateToString(mapped));
...
esp_err_t wifi_manager_init(void) {
    ...
    StateMachine::setInitial("wifi", stateToString(WifiManagerState::OFF));
